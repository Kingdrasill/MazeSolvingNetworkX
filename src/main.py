...
for j in sizes:
    ...
    for i in range(int(argv[1])):
        ...
        incio = tm.time()
        tm.sleep(0.001)
        path = mt.astar_shortest_path(G, source=start, target=finish, heuristic=mt.Manhattan)
        fim = tm.time()
        mem_usada = tr.get_traced_memory()
        tr.stop()
        tempo_exec = fim -incio
        ...
        incio = tm.time()
        tm.sleep(0.001)
        path = mt.astar_shortest_path(G, source=start, target=finish, heuristic=mt.Chebyshev)
        fim = tm.time()
        mem_usada = tr.get_traced_memory()
        tr.stop()
        tempo_exec = fim -incio
        ...
        incio = tm.time()
        tm.sleep(0.001)
        path = mt.astar_shortest_path(G, source=start, target=finish, heuristic=mt.Euclidian)
        fim = tm.time()
        mem_usada = tr.get_traced_memory()
        tr.stop()
        tempo_exec = fim -incio
        ...
        incio = tm.time()
        tm.sleep(0.001)
        path = mt.astar_shortest_path(G, source=start, target=finish, heuristic=mt.Euclidian_squared)
        fim = tm.time()
        mem_usada = tr.get_traced_memory()
        tr.stop()
        tempo_exec = fim -incio
